...
public class PermissionUtil {
    ...
    public static List<PermVo> listPermVo(List<PermissionShiro> permissions) {
        List<PermVo> root = new ArrayList<>();
        for (PermissionShiro permission : permissions) {
    ...
    public static List<PermissionShiro> listPermission(ApplicationContext context, String basicPackage) {
        Map<String, Object> map = context.getBeansWithAnnotation(Controller.class);
        List<PermissionShiro> permissions = new ArrayList<>();
        for (Map.Entry<String, Object> entry : map.entrySet()) {
            ...
            for (Method method : methods) {
                ...
                if (postMapping != null) {
                    ...
                    PermissionShiro permission = new PermissionShiro();
    ...
    public static Set<String> listPermissionString(List<PermissionShiro> permissions) {
